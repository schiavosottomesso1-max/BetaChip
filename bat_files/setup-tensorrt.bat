...
pip debug --verbose
pip install -r installation_helpers/requirements_tensorrt.txt --extra-index-url https://download.pytorch.org/whl/cu130 --cache-dir pip-cache/ --extra-index-url https://pypi.nvidia.com --prefer-binary --log install-log-tensorrt-verbose.txt --verbose
cd mmc_code
